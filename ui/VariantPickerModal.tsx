...
//               className={`w-full text-left p-2 rounded border ${selected === idx ? 'bg-blue-600 text-white' : 'bg-white'}`}
//             >
//               <div className="flex items-center gap-3">
//                 <img src={v.image ?? '/placeholder.png'} alt={v.color ?? v.ram ?? ''} className="w-12 h-12 object-cover rounded" />
//                 <div>
//                   <div className="font-medium">
//                     {(v.ram ? `${v.ram} • ` : '') + (v.rom ? `${v.rom} • ` : '') + (v.color ?? '')}
//                   </div>
//                   <div className="text-sm text-gray-600">₦{Number(v.price || 0).toLocaleString()}</div>
//                 </div>
//               </div>
//             </button>
//           ))}
          ...
          {variants.map((v: any, idx: number) => (
            <button
              ...
              className={`w-full text-left p-2 rounded border ${
                selected === idx ? 'bg-blue-600 text-white' : 'bg-white'
              }`}
            >
              <div className="flex items-center gap-3">
                <img
